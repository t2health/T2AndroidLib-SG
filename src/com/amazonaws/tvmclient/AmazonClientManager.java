...
public class AmazonClientManager {
	...
	private String mTokenVendingMachineURL = null;

	public AmazonClientManager(SharedPreferences settings, String tokenVendingMachineURL) {
		this.sharedPreferences = settings;
		this.mTokenVendingMachineURL = tokenVendingMachineURL;
	}
...
//					AmazonTVMClient tvm = new AmazonTVMClient( this.sharedPreferences, PropertyLoader.getInstance().getTokenVendingMachineURL(), PropertyLoader.getInstance().useSSL() );
					AmazonTVMClient tvm = new AmazonTVMClient( this.sharedPreferences, mTokenVendingMachineURL, PropertyLoader.getInstance().useSSL() );
